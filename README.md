...
打开英文或法文网页，掰it 自动把复杂长句拆成看得懂的块，保留缩进层级，一眼看清主从关系。刷推特、看 Reddit、读 Medium 文章，或者看法语新闻、法语维基——都能自动处理。

### 标注生词

不认识的词用虚线标出来，鼠标一放上去就能看到中文释义。内置英文和法语离线词典，不需要联网。你觉得已经认识的词，点一下标记掌握，以后就不再打扰你。
...
1. **装完即用** — 打开英文或法文网页，插件会自动识别语言并开始拆句、标注生词
...
| Qwen（通义） | qwen3.5-flash | 新的轻量快模，旧的 qwen3-flash 仍可选 |
